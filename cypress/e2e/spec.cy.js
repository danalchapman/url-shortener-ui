...
describe('Form flows', () => {
  ...
  it('Should be able to submit a new shortened URL to the DOM', () => {
    ...
    cy.intercept('POST', 'http://localhost:3001/api/v1/urls', {
      ...
      body: {
        "id": 4,
        "long_url": "https://images.unsplash.com/photo-1477511801984-4ad318ed9846?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bGF2ZW5kZXJ8ZW58MHx8MHx8&auto=format&fit=crop&w=400&q=60",
        "short_url": "http://localhost:3001/useshorturl/4",
        "title": "Lavender photo"
      }
    })
    cy.visit('http://localhost:3000/')
    cy.get('input[name="title"]')
      .type('Lavender photo')
      .should('have.value', 'Lavender photo')
    cy.get('input[name="urlToShorten"]')
      .type('https://images.unsplash.com/photo-1477511801984-4ad318ed9846?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bGF2ZW5kZXJ8ZW58MHx8MHx8&auto=format&fit=crop&w=400&q=60')
      .should('have.value', 'https://images.unsplash.com/photo-1477511801984-4ad318ed9846?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bGF2ZW5kZXJ8ZW58MHx8MHx8&auto=format&fit=crop&w=400&q=60')
    cy.get('button').should('exist').contains('Shorten Please!').click()
    cy.get('h3').contains('Lavender photo')
    cy.get('a')
      .contains('http://localhost:3001/useshorturl/4')
    cy.get('p')
      .contains('https://images.unsplash.com/photo-1477511801984-4ad318ed9846?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bGF2ZW5kZXJ8ZW58MHx8MHx8&auto=format&fit=crop&w=400&q=60')
  })
})